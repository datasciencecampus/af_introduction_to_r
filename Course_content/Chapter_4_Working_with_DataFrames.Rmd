...
# Using gsub to replace a comma with nothing

names(titanic) <- gsub("," , "", names(titanic))

# Using gsub to replace a hyphen space with an underscore
...
2. How many passengers do not have siblings or spouses ('sibsp'), and parents or children ('parch') on the boat?
...
2. How many passengers who do not have siblings or spouses ('sibsp'), and parents or children ('parch') on the boat?
