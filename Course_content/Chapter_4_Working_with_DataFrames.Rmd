...
We can select columns which are next to each other in chunck as below.
...
For more advanced ways to filter columns refer to this excellent blog [Data Wrangling Part 1: Basic to Advanced Ways to Select Columns](https://suzan.rbind.io/2018/02/dplyr-tutorial-3/), this covers th functions, `filter_all()`, `filter_if()` and `filter_at`.
...
# Here we are over writting the  sex_of_passenger column
...
```{r, eval = FALSE}
# Recoding variables
# Note Recode does not have a .data arguement
...
For more advanced ways to mutate columns refer to this excellent blog [Data Wrangling Part 1: Basic to Advanced Ways to Mutate Columns](https://suzan.rbind.io/2018/02/dplyr-tutorial-2/), this covers th functions, `mutate_all()`, `mutate_if()` and `mutate_at`.
