...
<!-- Changed the indentation slightly to add alignment for the different bracket levels. Still looks a bit off, not really sure how to structure R code syntax so might be worth looking up --JM -->
```{r}
...
<!-- Really well structured explaination of what it does --JM -->
