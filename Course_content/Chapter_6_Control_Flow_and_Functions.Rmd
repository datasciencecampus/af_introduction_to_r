...
![Image showing a for loop](../Images/loop_example.png)
...
Alternatively you can do this without using the pipe operator as shown below,
...
male_passenger_mean_age <- mean(dplyr::filter(titanic, 
...
female_passenger_mean_age <- mean(dplyr::filter(titanic, 
