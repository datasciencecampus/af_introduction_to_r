...
![Seq help file](../Images/seq_helpfile.PNG){width=650px}
...
We can see that R has classed the column as character because of the `.` and `*` within it.
...
![\An image showing a folder structure layout](../Images/folder_structure.jpg)
