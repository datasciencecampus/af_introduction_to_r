...
* `functionName(parameter = argument1, parameter = argument2, and so on)`
...
3. Then `View` the column in R to see the data type R has set it to be. If you hover the mouse pointer on the name of the column it will R studio will display the datatype.
