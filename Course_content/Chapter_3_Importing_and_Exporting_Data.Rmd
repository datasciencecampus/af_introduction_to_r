...
You can always specify arguments in the form `name = value` But if you do not, R attempts to resolve by position. 
...
1. Having read in the titanic data above, have a look at the column name Of Passenger.
...
1. Have a look at the column name Of Passenger.
...
> **Where there is the word "NULL", class is it as a missing value.**
