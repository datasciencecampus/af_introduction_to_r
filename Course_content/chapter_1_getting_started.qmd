...
Create an R project in an **existing directory**, selecting the root folder of the course materials provided. 

This is the folder that contains all the sub-folders such as **data**, **course_content** etc. 

We will do the same here as well.

![](../Images/root_folder.png){fig-alt="The root folder showing the .Rproj file alongside the othr folders."}
...
![](../Images/project_menu.png){fig-alt="The top right menu that allows us to interact with projects."}
