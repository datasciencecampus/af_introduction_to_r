...
>**We could restructure using `tidyr` functions: pivot_wider()`, `separate()` and `pivot_longer()`. This is slightly advanced for what we have covered so far, but an examples have been added to the additional materials for those keen to know.**
