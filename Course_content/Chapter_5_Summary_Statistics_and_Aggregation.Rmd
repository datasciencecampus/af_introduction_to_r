...
my_summary_stats <- dplyr::summarise(.data = titanic, 
...
>**Code show below to dmeonstrate, refer to additional material for more details as tidy**
...
my_summary_stats %>% 
pivot_longer(cols = median_fare:sd_age,
             names_to = "statistic",
             values_to = "value")
```
...
new_theme <- theme(
  plot.title = element_text(
    ...
    vjust = 1
  ), # Vertical Adjustment, raises it slightly

  plot.subtitle = element_text( # Subtitle
  
    size = 14, # Font size
    hjust = 0
  ), # Horizontal adjustment, this will left align
...
ggplot2::ggplot(median_fare,
  ...
  labs(
    title = "Number of passengers In Each Class", # labels
    x = "Passenger Class",
