...
The `janitor` package offers many functions used to manipulate data, e.g removing empty rows and columns, finding duplicates within a dataframe. In this session we will use the library to to clean our data set names.
