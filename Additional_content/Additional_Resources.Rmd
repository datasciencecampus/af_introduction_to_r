...
Well you could use summarize as discussed in chapter five -summary statistics, but this becomes inconvenient when you have many columns, as summarize requires you to type out a column name and a data tranformation for each summary statistic that you want to calculate.
...
So the creators of purrr have made a shortcut for this because it is so commonly done.

* In the shortcut we replace function(VARIABLE) with a ~
