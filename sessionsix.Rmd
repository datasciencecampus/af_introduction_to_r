...
In R you have multiple options when repeating operations, `vectorized operations`, `for loops`, and `apply functions`.

We covered 'vectorized operations` in session 2 (section 1.4), we will look at loops in this session and we will not cover the apply functions in this course.
