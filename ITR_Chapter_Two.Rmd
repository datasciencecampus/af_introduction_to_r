...
2.Create 2 vectors, one with numeric data and one with character data, e.g favourite_movies and lucky_numbers. `(Feel free to be creative here)`.


3.Now combine the 2 vectors to create a new vector, e.g movies_and_numbers
...
Vectors aren't just containers for homogeneous data. 
...
1. Refering to our previous exercise where we created the vectors below, create a list containing the contents of the 2 vectors, I have named my list, `my_list_of_movies_and_numbers`
...
So if i wanted to select the 4th item from the favourite_movies, I would type the code below,
...
Below is an example of a what a dataframe and tibble look like, I have used the same dataset.
...
* Vectors are the most fundamental object type available in R as it's a vectorised language.
