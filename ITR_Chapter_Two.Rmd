...
my_list_of_movies_and_numbers <- list(7, 12, 15, 1,"Frozen", "The Lion King", "Moana", "The Dark Knight") 
...
* Select your favourite chocolate from the options
...
#select your favourite chocolate bar
