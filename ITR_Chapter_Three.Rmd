...
>e.g. `"C:/users/[yourName]/Documents/Training/Intro_to_R"`
...
```
If our current working directory is 'Intro to R', and we want to switch to 'Data', we can use the relative path:
...
Alternatively you could use the name of the sheet rather than the number. 
...
When you read a file into R, the data are loaded in memory. This means that any changes you make won't be reflected in the original file you loaded. If you want to preserve the changes you make to the dataset you have to export the data object to a file.
...
After importing our data, The first thing we may want to do is have a quick look at it to check it looks right.
 ...
 * How to orgasnise our work, ie. projects or have organised folders
