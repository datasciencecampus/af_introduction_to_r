...
1. The `range()` in R, doesnt show the difference between the hiegest value and the lowest value, but rather shows the hiegest value.
...
```
 Can create a function called my_range which return the difference between the hiegest value and the lowest value?
