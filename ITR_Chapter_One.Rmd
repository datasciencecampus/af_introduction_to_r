...
Explore the various themes available to you in R Studio by going to Tools -> Global Options -> Appearance
...
To save the script we can use the short cut **CTRL + S** or alternatively save from the file menu.
...
print("R can be used as a calculator")
