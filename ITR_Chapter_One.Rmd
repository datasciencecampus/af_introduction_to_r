...
If you dont see the Code editor pane, go to the toolbar and click **View** -> **Panes** -> **Show All Panes**.
...
The Environment pane is very useful as it shows you what objects (such as; dataframes, values and functions) you have in your environment (workspace).
...
Variables are an integral part of any programming language. Variables allow us to store and label data under a specific name. It is like a placeholder, used to store information. Think of it as a container, they main purpose is to label and store the data in memory.
