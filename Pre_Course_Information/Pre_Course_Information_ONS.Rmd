...
* I Want Something > Top Requested Forms > Computer Software > Add / Transfer / Remove.

<br>

![](../Images/service_desk_1.png)
...
![](../Images/service_desk_2.png)


<br>

* Type `THE` in the box and then select `THE RSTUDIO BUNDLE` and click the arrow to move it in the selected box.

<br>


![](../Images/service_desk_3.png)

<br>

* You should now have `THE RSTUDIO BUNDLE` in the selected box.

<br>


![](../Images/service_desk_4.png)

<br>

* The type in your Asset number, this is the number starting with `ONS` on the sticker on your laptop

* Then select `No` for software to be installed on multiple PC's.

<br>

![](../Images/service_desk_5.png)
...
The [Wiki pages](https://collaborate2.ons.gov.uk/confluence/display/WIKIRS/1+-+RStudio+New+Bundle) (section 1.2) will help you to self install and run RStudio on your machine once your service desk request has been completed. You will need a confluence account to access this page, which can be requested on the service desk, but the instructions are replicated below: 

Once your service desk call requesting the software has been closed, you should see RStudio in your Software Center - this can be found by pressing the search button on your task bar and typing Software Center, or by going to Microsoft System Center from the Start Menu. 

The new RStudio bundle will appear in the list, and will say COIRAM/ONS underneath the name. Click on this, and press Install. A window will pop up informing you that the software is installing - do not close this window until the process is complete! It should take about 5 minutes. 
